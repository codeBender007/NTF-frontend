...
const Home = () => {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      {/* Content */}
      <div className="min-h-screen flex items-center justify-center px-5 py-10 sm:px-8">
        <div className="w-full max-w-[1100px]">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:gap-10 max-w-[1050px] mx-auto">
            {cards.map((card) => {
              const Icon = card.icon;
              ...
              return (
                <div
                  ...
                  className="
                    ...
                    duration-300
                    hover:-translate-y-2
                    hover:shadow-[0_18px_40px_rgba(111,74,231,0.20)]
                  "
                >
                  {/* Icon Circle */}
                  <div
                  ...
                  >
                    <div
                      className="
                        ...
                        font-semibold
                        text-white
                        shadow-[0_4px_12px_rgba(111,74,231,0.25)]
                        transition-all
                        duration-300
                        hover:opacity-95
                        hover:shadow-[0_6px_16px_rgba(111,74,231,0.35)]
                        active:scale-[0.98]
                      "
                    >
                      Open {card.title}
